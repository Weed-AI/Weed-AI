...
api_urlpatterns = [
    ...
    path("upload_mask/", views.upload_mask, name="upload_mask"),
    path("remove_mask/", views.remove_mask, name="remove_mask"),
    path("submit_mask/", views.submit_mask, name="submit_mask"),
    path("move_mask/", views.move_mask, name="move_mask"),
