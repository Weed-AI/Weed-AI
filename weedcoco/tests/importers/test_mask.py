...
def converter(tmpdir):
    ...
    class Converter:
        def run(self, extra_args, mask_dir=TEST_MASK_DIR, path_to_mask_pattern="...."):
            args = ["--mask-dir", mask_dir, "-o", out_path]
...
def test_image_ext(converter):
    ...
    expected = copy.deepcopy(BASIC_EXPECTED)
    expected["images"][0]["file_name"] = "0011.jpeg"
    expected["images"][1]["file_name"] = "0042.jpeg"
    expected["images"][2]["file_name"] = "0054.jpeg"
