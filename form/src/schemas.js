// Currently this takes a json version of our yaml schema.
// Eventually, some sort of github action to regenerate this based upon changes to the yaml would be awesome.
export const agcontextSchema = {
